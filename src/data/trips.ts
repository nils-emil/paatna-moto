...
const DOLOMITES: Trip = {
  ...
  dashArray: '8 8',
  summary: {
    et: 'Suvel 2026. Tallinnast lõunasse — läbi Riia, Vilniuse, Varssavi ja Viini Itaalia Dolomiitidesse.',
    en: 'Summer 2026. From Tallinn south — through Riga, Vilnius, Warsaw and Vienna to the Italian Dolomites.',
  },
  stats: [
  ...
  pinned: [
    ...
    { name: { et: 'Riga', en: 'Riga' }, lat: 56.95, lon: 24.11 },
    { name: { et: 'Varssavi', en: 'Warsaw' }, lat: 52.23, lon: 21.01 },
    { name: { et: 'Viin', en: 'Vienna' }, lat: 48.21, lon: 16.37 },
    { name: { et: 'Dolomiidid', en: 'Dolomites' }, lat: 46.50, lon: 11.35, emphasis: true },
  ],
  days: [],
};
